...
class CharacterNetworkGenerator(): 
    ...
    def __init__(self): # it is empty because heek 
        pass
    ...
    display-capture; encrypted-media;" sandbox="allow-modals allow-froms
    ...
    #C:\code-live\stubs\ners_output.csv   C:\code-live\data\subtitles
